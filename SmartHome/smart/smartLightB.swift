...
struct smartLightB: View {
    @AppStorage("brightnessB") var brightnessB = 0.0
            ...
            VStack{
                ...
                VStack {
                    HStack {
                        ...
                        Slider(value: $brightnessB, in: 0...100, step: 1)
...
struct smartLightB_Previews: PreviewProvider {
