...
struct smartLightD: View {
    @AppStorage("brightnessD") var brightnessD = 0.0
            ...
            VStack{
                ...
                VStack {
                    HStack {
                        ...
                        Slider(value: $brightnessD, in: 0...100, step: 1)
...
struct smartLightD_Previews: PreviewProvider {
